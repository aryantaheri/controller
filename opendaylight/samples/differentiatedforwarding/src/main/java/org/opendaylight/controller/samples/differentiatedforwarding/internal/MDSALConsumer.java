...
public class MDSALConsumer implements BindingAwareConsumer, IMDSALConsumer {
    ...
    void init(Component c) {
        ...
        logger.info("DifferentiatedForwarding Registered with MD-SAL");
    ...
    public void onSessionInitialized(ConsumerContext session) {
        ...
        logger.info("DifferentiatedForwarding Session Initilized with CONSUMER CONTEXT {}, and dataBrokerService {}, and dataBroker {}", session.toString(), dataBrokerService, dataBroker);
    }
